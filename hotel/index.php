...
<body>
    <nav class="navbar">
        <div class="left-nav">
            <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/ce/e2/7f/kankakee-grille.jpg?w=1200&h=-1&s=1" alt="logo">
        </div>
        <div class="right-nav">
            <ul>
    ...
    <section id="rooms-right">
        <div class="paras">
          ...
          <div class="thumbnail">
          <img src="https://storage.googleapis.com/hotels2thailand-storage/pictures/products/01287901-231867-original.jpg" alt="delux" class="imgFluid">
          </div>
    </section>
    ...
    <section id="rooms-left">
        <div class="paras">
          ...
          <div class="thumbnail">
           <img src="https://th.bing.com/th/id/OIP.qe8Y1CSihZTpPoIY9fLQqQHaE8?w=960&h=640&rs=1&pid=ImgDetMain" alt="delux" class="imgFluidd">
          </div>
    </section>
    ...
    <section id="rooms-right">
        <div class="paras">
          ...
          <div class="thumbnail">
          <img src="https://images.pexels.com/photos/271618/pexels-photo-271618.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="delux" class="imgFluid">
          </div>
    </section>
    ...
    <section id="services-container">
        ...
        <div id="services">
            <div class="box">
                <a href="food.php"><img src="https://th.bing.com/th/id/OIP.ItkQ1zqQ9s6lKGcaWKEzdQHaEL?pid=ImgDet&w=168&h=94.75200000000001&c=7&dpr=1.3" alt="manchurion"></a>
            ...
            <div class="box">
                 <a href="food.php"><img src="https://th.bing.com/th/id/OIP.TsjX5R6YQjq8bSqSVW3qyQHaE7?pid=ImgDet&w=168&h=111.92432432432433&c=7&dpr=1.3" alt="pasta"></a>
             ...
             <div class="box">
             <a href="food.php"><img src="https://th.bing.com/th/id/OIP.rGv9ntRh-rWq0kak5NRs2AHaFZ?w=213&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" alt="maharshtrian"></a>
        ...
        <div id="services">
            <div class="box">
            <a href="food.php"><img src="https://freshindianfood.com/wp-content/themes/rotigrill/assets/images/slider-img.webp" alt="panner"></a>
            ...
            <div class="box">
            <a href="food.php"><img src="https://th.bing.com/th/id/OIP.DW1OY9n6PDlJyRflLdQoWAHaEN?pid=ImgDet&w=168&h=95.54828150572831&c=7&dpr=1.3" alt="dosa"></a>
                <h2 class="h-secondary center">South-Indian</h2>
                <p class="center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Autem, assumenda magni sequi maxime ullam magnam minima porro tempore enim sed quidem sint provident facere fugiat facilis qui saepe quia? Aut, repudiandae?Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas nulla sit, perspiciatis temporibus unde </p>
             </div>
             <div class="box">
             <a href="food.php"><img src="https://th.bing.com/th/id/OIP.uAIPUni7RD-i9bSBb3MTDAAAAA?pid=ImgDet&w=122.03999999999999&h=180&c=7&dpr=1.3" alt="faluda"></a>
    ...
    <section id="footer" class="section footer">
        <div class="container">
            <div class="footer-container">
                ...
                <div class="footer-center">
                    <h3>CONTACT INFO</h3>
                    <p>cox'sbazar,bangladesh, <br>paradaish,Pin-414001 <br>+91 7821893289 <br>www.hotel.com</p>
                </div>
                <div class="footer-center">
                    <h3>OPENING HOURS</h3>
                    <div>
